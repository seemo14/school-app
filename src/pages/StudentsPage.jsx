...
import { getStudents, deleteStudent, deleteMany, type Student } from "@/utils/dataService";
...
export default function StudentsPage() {
  ...
  function exportCSV() {
    const cols: (keyof Student)[] = ["id", "fullName", "classLevel", "gender", "dateAdded"];
      ...
      <div className="flex items-center gap-3 mb-3">
        <label className="text-sm flex items-center gap-2">
          ...
          <select
            ...
            onChange={(e) => { setSortBy(e.target.value as keyof Student); setSortDir("asc"); }}
          >
...
/* --- tiny utility classes with Tailwind --- */
/* Put these in your globals if you prefer; inline here for clarity */
declare global {
  interface HTMLElementTagNameMap {
    // nothing; just keeping TS happy if you move utilities elsewhere
  }
}
